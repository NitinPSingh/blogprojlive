...
SECRET_KEY = 'gd8qi&9tblxlpgpmw5m@n(q#jhvx^np1(9y_zrg)sug_n-&d=y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['nitinsingh46.herokuapp.com','127.0.0.1']
...
DATABASES = {
    'default': {
        ...
        'USER':'postgres',
        'PASSWORD':'nitinAWS',
        'HOST':'database-3.ci0ohjipodzi.ap-south-1.rds.amazonaws.com',
        'PORT':'5432'
    }
}
# Password validation
